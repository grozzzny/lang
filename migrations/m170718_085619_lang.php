...
class m170718_085619_lang extends Migration
{
    ...
    public function up()
    {
        ...
        $this->batchInsert('gr_lang', ['url', 'local', 'name', 'default', 'date_update', 'date_create'], [
    ...
    {
        $this->dropTable('{{%gr_lang}}');
        echo "m170718_085619_lang cannot be reverted.\n";
